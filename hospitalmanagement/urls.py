...
urlpatterns = [
    ...
    path('doctorsignup/doctorlogin/', RedirectView.as_view(url='/doctorlogin/', permanent=False)),
    path('doctorlogin/doctorsignup/', RedirectView.as_view(url='/doctorsignup/', permanent=False)),
    path('adminsignup/adminlogin/', RedirectView.as_view(url='/adminlogin/', permanent=False)),
...
urlpatterns +=[
    ...
    path('doctor-queue/', views.doctor_queue_view, name='doctor-queue'),
    path('doctor-call-patient/<int:token_id>/', views.doctor_call_patient_view, name='doctor-call-patient'),
    path('doctor-complete-consultation/<int:token_id>/', views.doctor_complete_consultation_view, name='doctor-complete-consultation'),
]
